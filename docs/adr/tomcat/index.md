...
| [**TC-ADR-0010**](adr-records/TC-ADR-0010.md){: target="_blank" } | Host Environment Configuration Architecture (bin/setenv) and Dynamic Container-Aware JVM Memory Tuning for Zero-Downtime Deployments | Apache Tomcat Enterprise | Runtime and Deployment Architecture | Accepted | 2026-09-25 |
...
| **TC-ADR-0010** | Host Environment Configuration Architecture (bin/setenv) and Dynamic Container-Aware JVM Memory Tuning for Zero-Downtime Deployments | Platform Foundation TN-010, [Tomcat Architecture](../../projects/tomcat/architecture/index.md), [Update Management](../../projects/tomcat/update-management/index.md) |
