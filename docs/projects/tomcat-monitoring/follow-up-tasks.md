...
- **Status:** `Completed (Fase 2)` ✅ (TN-013)
- **Deskripsi:**
...
- **Bukti Verifikasi (*Verification Evidence*):**
  - Didokumentasikan secara lengkap pada [TN-013](engineering-journal/continuous-integration-and-deployment/TN-013-implement-unified-cross-platform-event-collector-daemon-tm-agent.md).
  - Repositori mandiri [`tm-agent`](file:///home/eddywiyatno/git/tm-agent) diinisialisasi dan lulus 100% unit tests internal.
...
- **Referensi:** [TM-ADR-0008](../../adr/tomcat-monitoring/adr-records/TM-ADR-0008.md), [TM-ADR-0027](../../adr/tomcat-monitoring/adr-records/TM-ADR-0027.md), [TN-011](engineering-journal/continuous-integration-and-deployment/TN-011-design-cross-platform-container-engine-api-orchestration-and-agent-architecture.md), [TN-013](engineering-journal/continuous-integration-and-deployment/TN-013-implement-unified-cross-platform-event-collector-daemon-tm-agent.md).
...
- **Status:** `Completed (Fase Cloud Linux)` ✅
- **Deskripsi:**
...
| **TASK-TM-035** | Fleksibilitas Topologi Deployment, Standarisasi `tm_data`, & TLS Governance | **P1 (High)** | `Completed` ✅ | [TM-ADR-0028](../../adr/tomcat-monitoring/adr-records/TM-ADR-0028.md) | Ansible / Jenkins / Config | Profil topologi (all_in_one, monitoring_node, central_hub), TLS auto-renewal, & path tm_data (TN-020 s.d. TN-022) |
| **TASK-TM-036** | Otomatisasi Provisi Docker Windows & Dual-Container Mode | **P1 (High)** | `Completed` ✅ | [TM-ADR-0026](../../adr/tomcat-monitoring/adr-records/TM-ADR-0026.md) | Scripts / Ansible / Jenkins | Installer remote SSH, reboot windowsfilter resume, System32 placement, & Dual-Container Mode (TN-023) |
| **TASK-TM-037** | Otomatisasi Provisi Linux Host & Multi-Distro Runtime Detection | **P1 (High)** | `Completed` ✅ | [TM-ADR-0026](../../adr/tomcat-monitoring/adr-records/TM-ADR-0026.md) | Scripts / Ansible / Fleet | Remote SSH bootstrapper, inspeksi runtime, fallback Docker AL2023, & swap hardening (TN-024) |
