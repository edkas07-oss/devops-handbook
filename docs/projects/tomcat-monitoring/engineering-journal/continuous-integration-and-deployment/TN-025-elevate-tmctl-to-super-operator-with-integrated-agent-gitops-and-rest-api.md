...
Aktivitas ini mengeksekusi keputusan arsitektur [TM-ADR-0032](../../../../adr/tomcat-monitoring/adr-records/TM-ADR-0032.md).
...
- [TM-ADR-0032 — Consolidation of Fragmented Observability Landscape into tmctl Super Operator, Pure Pull-Based GitOps Engine, and Host Telemetry Agent Absorption](../../../../adr/tomcat-monitoring/adr-records/TM-ADR-0032.md)
...
- [TN-012 — Implement Unified Cross-Platform Operator CLI tmctl](TN-012-implement-unified-cross-platform-operator-cli-tmctl.md)
- [TN-013 — Implement Unified Cross-Platform Event Collector Daemon tm-agent](TN-013-implement-unified-cross-platform-event-collector-daemon-tm-agent.md)
- [tcctl Architecture & Operations Guide](../../../tomcat/engineering-journal/index.md)
